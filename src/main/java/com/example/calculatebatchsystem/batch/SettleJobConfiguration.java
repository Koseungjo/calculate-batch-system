package com.example.calculatebatchsystem.batch;

import com.example.calculatebatchsystem.batch.support.DateFormatJobParametersValidator;
...
public class SettleJobConfiguration {
    ...
    // 일일 정산 배치
    // 1주일 간의 데이터를 집계해서
    // 데이터 베이스에 쌓고, 고객사에 Email로 전송한다. (Fake)
    @Bean
